...
# ============================================================
# 1. إعدادات LangSmith Tracing
# ============================================================
os.environ["LANGCHAIN_TRACING_V2"] = "true"
os.environ["LANGSMITH_TRACING"] = "true"
# استبدل المفتاح الخاص بك هنا
os.environ["LANGCHAIN_API_KEY"] = "lsv2_pt_YOUR_API_KEY_HERE"
os.environ["LANGCHAIN_PROJECT"] = "multi-agent-rag-system"
...
# ============================================================
# 2. Design System - الألوان، الخطوط والأنماط
# ============================================================
class DesignSystem:
    def __init__(self,
                 arabic_font_path: str = "C:/Windows/Fonts/tahoma.ttf",
                 arabic_bold_font_path: str = "C:/Windows/Fonts/tahomabd.ttf"):
        ...
        if not os.path.exists(arabic_font_path):
            raise FileNotFoundError(
                ...
                "تأكد أن Tahoma موجود بـ C:/Windows/Fonts أو مرر مسار خط بديل."
            )
    ...
    def title_style(self):
        return ParagraphStyle(
            ...
            leading=28,  # إضافة leading متناسب مع الخط
    ...
    def heading_style(self):
        return ParagraphStyle(
            ...
            leading=20,  # إضافة leading متناسب مع الخط
